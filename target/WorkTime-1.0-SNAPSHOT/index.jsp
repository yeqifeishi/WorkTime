...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="<%=path%>/images/face.jpg" class="layui-nav-img userAvatar" width="35"
                                                height="35"><cite class="adminName">FY</cite></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" data-url="user/userInfo.html"><i class="seraph icon-ziliao"
                                                                                         data-icon="icon-ziliao"></i><cite>个人资料</cite></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="user/changePwd.html"><i class="seraph icon-xiugai"
                        ...
                        <dd>
                            <a href="logout.do" class="signOut"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="<%=path%>/images/face.jpg" class="userAvatar"></a>
            <p>你好！<span class="userName">${user.emp_name}</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="<%=path%>/page/main.jsp"><i class="layui-icon"
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2020 YZJYZJ</span>　　</p>
    </div>
</div>
...
<script type="text/javascript" src="<%=path%>/js/cache.js"></script>
</body>
